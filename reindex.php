...
<head>
    <meta charset="utf-8">
    <title>KHOA ĐIỆN TỬ - ĐẠI HỌC CÔNG NGHIỆP HÀ NỘI || HAUI</title>
    ...
    <div class="container-fluid bg-primary text-white d-none d-lg-flex">
        <div class="container py-3">
            <div class="d-flex align-items-center">
                <a href="reindex.php">
                    <h2 class="text-white fw-bold m-0">KHOA ĐIỆN TỬ</h2>
                </a>
                <div class="ms-auto d-flex align-items-center">
                    <small class="ms-4"><i class="fa fa-map-marker-alt me-3"></i>Số 298 đường Cầu Diễn, quận Bắc Từ Liêm, Hà Nội</small>
                    <small class="ms-4"><i class="fa fa-envelope me-3"></i>Email: dhcnhn@haui.edu.vn</small>
                    <small class="ms-4"><i class="fa fa-phone-alt me-3"></i>+84 243 765 5121</small>
                    <div class="ms-3 d-flex">
                        <a class="btn btn-sm-square btn-light text-primary rounded-circle ms-2" href="https://www.facebook.com/KhoaDienTuHaUI"><i
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
                <a href="index.php" class="navbar-brand d-lg-none">
                    <h1 class="fw-bold m-0">KHOA ĐIỆN TỬ</h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">ĐÀO TẠO</a>
                            <div class="dropdown-menu bg-light rounded-0 rounded-bottom m-0">
                                <a href="feature.html" class="dropdown-item">CÔNG NGHỆ KỸ THUẬT ĐIỆN TỬ VIỄN THÔNG</a>
                                <a href="team.html" class="dropdown-item">MẠNG MÁY TÍNH VÀ TRUYỀN THÔNG DỮ LIỆU</a>
                                <a href="testimonial.html" class="dropdown-item">CÔNG NGHỆ KỸ THUẬT MÁY TÍNH</a>
                            </div>
                        </div>
            ...
            <div class="row g-0 feature-row">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <p class="mb-0">Khoa điện tử trường đại học công nghiệp dạy học theo chuẩn ABET</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <p class="mb-0">Nơi có thể quản lý sinh viên và thông báo tình hình học tập</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <p class="mb-0">Bao gồm các thầy,cô giáo có chuyên môn có thể đưa ra những lời khuyên tốt</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-0">
                <div class="col-lg-6">
                    <div class="h-100 d-flex align-items-center justify-content-center" style="min-height: 300px;">
                        <button type="button" class="btn-play" data-bs-toggle="modal"
                            data-src="https://www.youtube.com/watch?v=HBw1-_Zqf1o" data-bs-target="#videoModal">
                            <span></span>
                        </button>
                    </div>
                </div>
                <div class="col-lg-6 pt-lg-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="bg-white rounded-top p-5 mt-lg-5">
                        ...
                        <h1 class="display-6 mb-4">Trang Khoa điện tử</h1>
                        <p class="mb-4">Hệ thống có thể giúp thầy,cô giáo có thể quản lý sinh viên và trao đổi về tình hình học tập</p>
                        <div class="row g-5 pt-2 mb-5">
                            <div class="col-sm-6">
                                <img class="img-fluid mb-4" src="img/icon/icon-5.png" alt="">
                                <h5 class="mb-3">Học kết hợp</h5>
                            ...
                            <div class="col-sm-6">
                                ...
                                <span>Giải pháp giúp sinh viên có thể thi online</span>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item rounded overflow-hidden pb-4">
                        ...
                        <ul class="team-social">
                            <li><a class="btn btn-square" href="https://www.facebook.com/hung.vina.754"><i class="fab fa-facebook-f"></i></a></li>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    <h4 class="text-white mb-4">Trụ sở chính</h4></h4>
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Số 298 đường Cầu Diễn, quận Bắc Từ Liêm, Hà Nội
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+84 243 765 5121</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>Email: dhcnhn@haui.edu.vn</p>
                    <div class="d-flex pt-3">
                        <a class="btn btn-square btn-light rounded-circle me-2" href=""><i
                                class="fab fa-twitter"></i></a>
                        <a class="btn btn-square btn-light rounded-circle me-2" href="https://www.facebook.com/KhoaDienTuHaUI"><i
                                class="fab fa-facebook-f" href=""></i></a>
                        <a class="btn btn-square btn-light rounded-circle me-2" href=""><i
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center mb-3 mb-md-0">
                    &copy; <a class="fw-medium text-light" href="#">Copyright</a> Nhóm 5 Đồ án chuyên ngành
                </div>
            </div>
        </div>
    </div>
